  ...
  return (
    <div className="h-fit w-full">
      <div className="bg-neutral-950 w-full h-full flex bg-gradient-to-b from-[#1a1945] to-[#5f5cc4] py-[10vh] px-52 flex-col gap-10 items-center">
        ...
        <h1 className="font-phonk text-4xl text-white text-center">{("UNIM8S Semester 2 2025").toUpperCase()}</h1>
        <a 
        ...
        >
          <div className="w-full h-full bg-white flex flex-row items-center justify-center rounded-lg gap-5">
            <p className="text-[#1a1945] text-center font-phonk text-3xl">{("Basketball").toUpperCase()}</p>
            <p className="text-xl text-[#1a1945] text-center font-phonk">{("A B Grade").toUpperCase()}</p>
          </div>
        </a>
        <a 
